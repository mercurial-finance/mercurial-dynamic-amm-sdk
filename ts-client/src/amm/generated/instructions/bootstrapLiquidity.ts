...
export interface BootstrapLiquidityArgs {
  tokenAAmount: BN
  tokenBAmount: BN
}

export interface BootstrapLiquidityAccounts {
  /** Pool account (PDA) */
  pool: PublicKey
...
export function bootstrapLiquidity(
  ...
  const identifier = Buffer.from([4, 228, 215, 71, 225, 253, 119, 206])
