...
export interface InitializePermissionlessPoolWithFeeTierArgs {
...
export interface InitializePermissionlessPoolWithFeeTierAccounts {
...
export function initializePermissionlessPoolWithFeeTier(
  ...
  const identifier = Buffer.from([6, 135, 68, 147, 229, 82, 169, 113])
