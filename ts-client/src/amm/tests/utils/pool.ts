...
export const simulateInitializePermissionlessPoolWithFeeTier = async (connection: Connection,
  ...
  let { pool, poolLpMint, aVaultAccount, bVaultAccount, instruction } = await initializePermissionlessPoolWithFeeTierInstruction(connection, aVault, bVault, ammProgram, vaultProgram, userKeypair, curve, aDepositAmount, bDepositAmount, tradeFeeBps);
...
export const initializePermissionlessPoolWithFeeTier = async (connection: Connection,
  ...
  export const initializePermissionlessPoolWithFeeTierInstruction = async (connection: Connection,
                                                              aVault: PublicKey, bVault: PublicKey, ammProgram: AmmProgram, vaultProgram: VaultProgram, userKeypair: Keypair, curve: CurveType, aDepositAmount: BN, bDepositAmount: BN, tradeFeeBps: BN
) => {
  ...
  let instruction = ammProgram.methods.initializePermissionlessPoolWithFeeTier(
    curve as any,
    tradeFeeBps,
    aDepositAmount,
    bDepositAmount
